...
_TRANSLATIONS: dict[str, ReportTranslations] = {
    ...
    "en": ReportTranslations(
        language="en",
        pdf_title="EcoPilot Report",
        cover_subtitle="EcoPilot report from {start} to {end}",
        ...
        notification_title="EcoPilot PDF Reporting Tool",
        notification_line_period="EcoPilot report generated for {start} to {end}.",
